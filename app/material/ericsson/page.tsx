...
import { Package, Edit, AlertCircle, ChevronDown, ChevronUp, Trash2 } from "lucide-react"
...
export default function EricssonMaterialPage() {
      ...
      <div className="container mx-auto py-6">
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            ...
            <p className="text-muted-foreground mt-1">Manage Ericsson equipment and materials inventory</p>
          </div>
        </div>
        ...
        <Card>
          <CardContent className="text-center py-8">
            ...
            <p className="text-sm text-muted-foreground">Click "Setup Database" to initialize the system</p>
          </CardContent>
        </Card>
      </div>
    )
  ...
  return (
    <div className="container mx-auto py-6">
      <div className="flex items-center gap-4 mb-6">
        ...
        <CategoryDialog brand="ericsson" onCategoryCreated={fetchCategories} />
      </div>
